...
class C_Parser_PULP(Parser_HW_to_C):
    ...
    def __init__(self, graph, config_file, config_file_dir, verbose_level, perf_layer, precision_library, arch, app_directory, n_inputs=1):
    ...
    def copy_backend_files(self, node):
        ...
        if self.precision_library == "8bit":
            ...
            if "Addition" in node.name:
                ...
                #in1_in2_out = "_" + Input_type + Input_bits + "_" + node.get_parameter('second_input_activation_type')[0] + Second_Input_bits + "_" + Output_type + Output_bits
            ...
            Weight_bits = str(node.get_parameter('weight_bits'))
            ...
            in_out_weights = "_" + Input_type + Input_bits + "_" + Output_type + Output_bits + "_" + node.get_parameter('weight_type')[0] + Weight_bits
            ...
            if ("Conv" in node.name or "FullyConnected" in node.name) and node.get_parameter('output_activation_bits') != 32:
                ...
                in_out_weights = "_" + Input_type + in_bits_matmul + "_" + Output_type + Output_bits + "_" + node.get_parameter('weight_type')[0] + Weight_bits
