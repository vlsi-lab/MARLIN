...
file_mult_conf = "./NSGA2_compile_ultra/results_27s_ultra_txt/pareto_conf_80_50_Pc0.8_Pm0.8_seed1_singlepoint.txt"
file_mult_res = "./NSGA2_compile_ultra/results_27s_ultra_txt/pareto_res_80_50_Pc0.8_Pm0.8_seed1_singlepoint.txt"
...
if (number > 9 or number < 0):
    ...
    sys.exit()
if (list_idx < 0 or list_idx >len(best_candidates)-1 ):
    print("Error: list_idx out of range")
    sys.exit()
print(number)
# take the input value
in_t = in_t_all[number]  #image with label number

# take a single chromosome from the retrieved list
#chromosome = best_candidates[list_idx]
...
my_utils.print_json_from_NEMO_graph(json_graph, dory_folder, NEMO_graph)
